...
import 'forgot_password_screen.dart'; // هنحتاج نعمل الصفحة دي
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // دي الدالة الجديدة اللي هتوديك لصفحة نسيت كلمة السر
              ...
              child: Column(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: TextButton(
                      onPressed: _navigateToForgotPassword, // هنا الربط الجديد
                      child: Text(
                        'نسيت كلمة المرور؟',
                        style: TextStyle(
                          color: Color(0xFF89CFF0),
